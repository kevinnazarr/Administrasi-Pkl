...
@section('content')
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                ...
                <div class="bg-white/20 backdrop-blur-sm rounded-xl p-4 min-w-[220px] text-center md:text-right">
                    ...
                    <p class="text-sm text-blue-100 mt-1">
                        Terakhir diupdate: {{ $pembimbing->updated_at->format('d/m/Y') }}
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-md p-6 md:p-8 animate-fade-in">
        <form action="{{ route('pembimbing.update', $pembimbing->id_pembimbing) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
                        ...
                        @if ($pembimbing->foto)
                            <div class="mt-3 p-3 bg-gray-50 rounded-xl">
                                ...
                                <img src="{{ asset('storage/' . $pembimbing->foto) }}"
                                        alt="Foto Pembimbing"
                                        class="w-32 h-32 rounded-lg object-cover border-2 border-blue-200">
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 pt-6 border-t border-gray-200">
                ...
                <div class="flex gap-3 w-full md:w-auto">
                    <a href="{{ route('pembimbing.show', $pembimbing->id_pembimbing) }}"
        ...
        <div class="bg-blue-50 rounded-2xl shadow-md p-6 animate-fade-in">
            ...
            <div class="space-y-3">
                <div class="flex items-center">
                    ...
                    <span class="font-medium">{{ $pembimbing->nama }}</span>
                </div>
                <div class="flex items-center">
                    <span class="text-gray-600 w-32">NIP:</span>
                    <span class="font-medium">{{ $pembimbing->nip }}</span>
                </div>
                <div class="flex items-center">
                    <span class="text-gray-600 w-32">Jabatan:</span>
                    <span class="font-medium">{{ $pembimbing->jabatan ?? '-' }}</span>
                </div>
                <div class="flex items-center">
